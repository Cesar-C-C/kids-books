...
window.OVL = {
  rocket_parts(){
    return svgWrap(
      partSVG({px:600, py:80, name:'Nose cone', nameZh:'整流罩', fact:'the pointy top that cuts through the air', factZh:'尖尖的顶，帮火箭穿过空气',
        line:"I'm the Nose Cone — I pointy-top cut through the air!", lineZh:'我是整流罩，尖尖的顶帮火箭穿过空气！', lineKey:'rocket_parts_0'}) +
      partSVG({px:600, py:190, name:'Window', nameZh:'舷窗', fact:'a little round window to look outside', factZh:'圆圆的小窗，可以往外看',
        line:"I'm the Window — peek outside from the rocket!", lineZh:'我是舷窗，从火箭里往外看！', lineKey:'rocket_parts_1'}) +
      partSVG({px:600, py:420, name:'Fuel tank', nameZh:'燃料箱', fact:'holds the fuel that makes fire', factZh:'装燃料的地方，燃料燃烧产生动力',
        line:"I'm the Fuel Tank — I hold the fuel for fire!", lineZh:'我是燃料箱，装着让火箭燃烧的燃料！', lineKey:'rocket_parts_2'}) +
      partSVG({px:600, py:650, name:'Engine', nameZh:'发动机', fact:'burns fuel and shoots fire down', factZh:'燃烧燃料，从下面喷出火焰',
        line:"I'm the Engine — I burn fuel and shoot fire down!", lineZh:'我是发动机，燃烧燃料往下喷火！', lineKey:'rocket_parts_3'}) +
      partSVG({px:510, py:650, name:'Fins', nameZh:'尾翼', fact:'keep the rocket steady in the air', factZh:'让火箭飞得稳稳的',
  ...
  rocket_fuel(){
    return svgWrap(
      ...
      partSVG({px:570, py:660, name:'Flame', nameZh:'火焰', fact:'hot fire that pushes the rocket up', factZh:'炽热的火，把火箭往上推',
  ...
  rocket_countdown(){
    return svgWrap(
      ...
      partSVG({px:745, py:610, name:'Launch button', nameZh:'发射按钮', fact:'pressed when we count to GO', factZh:'数到发射时按下的按钮',
  ...
  rocket_launch(){
    return svgWrap(
      partSVG({px:655, py:375, name:'Rocket', nameZh:'火箭', fact:'flies up, up, up into the sky', factZh:'向上、向上飞进天空',
        line:"I'm the Rocket — up, up, up into the sky!", lineZh:'我是火箭，向上向上飞进天空！', lineKey:'rocket_launch_0'}) +
      partSVG({px:685, py:540, name:'Flame', nameZh:'火焰', fact:'fire shoots down so the rocket goes up', factZh:'火往下喷，火箭就往上飞',
  ...
  rocket_thrust(){
    return svgWrap(
      partSVG({px:575, py:565, name:'Hot gas', nameZh:'热气', fact:'shoots out the bottom of the engine', factZh:'从发动机底部喷出去',
  ...
  rocket_stage(){
    return svgWrap(
      partSVG({px:690, py:180, name:'Upper stage', nameZh:'上面一级', fact:'carries the satellite into space', factZh:'带着卫星飞向太空的那一段',
  ...
  rocket_space(){
    return svgWrap(
      partSVG({px:420, py:520, name:'Earth', nameZh:'地球', fact:'our home, looks small from space', factZh:'我们的家，从太空看很小',
  ...
  rocket_orbit(){
    return svgWrap(
      partSVG({px:640, py:300, name:'Satellite', nameZh:'卫星', fact:'a small machine that flies around Earth', factZh:'绕着地球飞的小机器',
        line:"I'm a Satellite — I fly around Earth!", lineZh:'我是卫星，绕着地球飞！', lineKey:'rocket_orbit_0'}) +
      partSVG({px:500, py:560, name:'Earth', nameZh:'地球', fact:'the satellite circles around it', factZh:'卫星绕着它转圈圈',
  ...
  rocket_satellite(){
    return svgWrap(
      partSVG({px:462, py:370, name:'Camera', nameZh:'相机', fact:'takes photos of Earth from up high', factZh:'从高处给地球拍照',
        line:"I'm the Camera — I take photos of Earth from high up!", lineZh:'我是相机，从高处给地球拍照！', lineKey:'rocket_satellite_0'}) +
      partSVG({px:695, py:195, name:'Antenna', nameZh:'天线', fact:'sends TV and phone signals', factZh:'发送电视和电话信号',
        line:"I'm the Antenna — I send TV and phone signals!", lineZh:'我是天线，发送电视和电话信号！', lineKey:'rocket_satellite_1'}) +
      partSVG({px:860, py:450, name:'Solar panel', nameZh:'太阳能板', fact:'catches sunlight to make power', factZh:'收集阳光当能量',
  ...
  rocket_reentry(){
    return svgWrap(
      ...
      partSVG({px:560, py:440, name:'Heat shield', nameZh:'防热盾', fact:'protects the capsule from the hot flame', factZh:'保护返回舱不被火焰烤坏',
  ...
  rocket_return(){
    return svgWrap(
      ...
      partSVG({px:595, py:535, name:'Capsule', nameZh:'返回舱', fact:'the part that comes home', factZh:'回家的那一部分',
  ...
  rocket_home(){
    return svgWrap(
      ...
      partSVG({px:720, py:560, name:'Home', nameZh:'家', fact:'the satellite is back where it belongs', factZh:'卫星回到了属于它的地方',
        line:"I'm Home — the satellite is back where it belongs!", lineZh:'我是家，卫星回到了属于它的地方！', lineKey:'rocket_home_1'})
    );
  }
};
