...
window.OVL = {
  ...
  bs_parts(){
    return svgWrap(
      partSVG({px:470, py:275, name:'Upper deck',     nameZh:'上层车厢',
      ...
      partSVG({px:470, py:490, name:'Lower deck',     nameZh:'下层车厢',
  ...
  bs_lower(){
    return svgWrap(
      partSVG({px:325, py:390, name:'Front door',     nameZh:'前门',
               fact:'where passengers hop on',
               factZh:'乘客上车的门',
               line:"Hop on here and tap your card!",
               lineZh:'在这里上车，刷一下卡！', lineKey:'bs_lower_0'}) +
      partSVG({px:1075, py:145, name:'Priority sign',  nameZh:'爱心座标志',
