...
window.OVL = {
  ...
  sb_driver(){
    return svgWrap(
      ...
      partSVG({px:620, py:590, name:'Steering wheel', nameZh:'方向盘', fact:'turns the bus', factZh:'转动巴士', line:"Turn me to steer the bus!", lineZh:'转我，巴士就转弯！', lineKey:'sb_driver_1', bg:'light'}) +
  ...
  sb_inside(){
    return svgWrap(
      ...
      partSVG({px:590, py:760, name:'Aisle', nameZh:'走道', fact:'the walkway in the middle', factZh:'中间的走道', line:"Walk down me to your seat.", lineZh:'沿着我走到你的座位。', lineKey:'sb_inside_1', bg:'light'}) +
      ...
      partSVG({px:540, py:500, name:'Friend', nameZh:'小伙伴', fact:'a happy child on board', factZh:'车上的开心小朋友', line:"Hi! I'm riding to school!", lineZh:'嗨！我正坐车去幼儿园！', lineKey:'sb_inside_3', bg:'dark'})
    );
  },
  sb_wheels(){
    return svgWrap(
  ...
  sb_aide(){
    return svgWrap(
      partSVG({px:450, py:520, name:'Bus aide', nameZh:'随车老师', fact:'helps the children', factZh:'照顾小朋友', line:"I help every child feel safe!", lineZh:'我让每个小朋友都安心！', lineKey:'sb_aide_0', bg:'dark'}) +
