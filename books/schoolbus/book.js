...
window.BOOK = {
  ...
  age: '4-8 岁',
  coverImg: 'assets/00_cover_c.png',
  audioDir: 'audio'
};

window.PAGES = [
  {
    img: 'assets/00_cover_c.png',
    cover: true,
    en: 'The Kindergarten School Bus',
    zh: '幼儿园校车'
  },
  {
    img: 'assets/01_parts_c.png',
