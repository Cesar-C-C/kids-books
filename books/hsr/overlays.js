...
window.OVL = {
  hsr_02: () => svgWrap(
    partSVG({px:820,py:490,name:'Train',nameZh:'高铁',fact:'waiting at the station',factZh:'在车站等待',
      line:"I'm the high-speed train — waiting at the station!", lineZh:'我是高铁，正在车站等着呢！', lineKey:'hsr_02_0'}) +
    partSVG({px:310,py:480,name:'Passengers',nameZh:'乘客',fact:'ready to board',factZh:'准备上车',
      line:"We're passengers — ready to hop aboard!", lineZh:'我们是乘客，准备好上车啦！', lineKey:'hsr_02_1'}) +
    partSVG({px:140,py:150,name:'Station',nameZh:'车站',fact:'a modern platform',factZh:'现代化的站台',
      line:"I'm the station — a bright modern platform!", lineZh:'我是车站，明亮的现代化站台！', lineKey:'hsr_02_2'})
  ),
  hsr_03: () => svgWrap(
    partSVG({px:405,py:540,name:'Streamlined nose',nameZh:'流线型车头',fact:'cuts through the wind',factZh:'能切开风',
      line:"I'm the streamlined nose — I cut through the wind!", lineZh:'我是流线型车头，我能切开风！', lineKey:'hsr_03_0'}) +
    partSVG({px:400,py:295,name:'Wind',nameZh:'风',fact:'slides over the smooth shape',factZh:'沿着光滑外形滑过',
      line:"I'm the Wind — I slide over the smooth nose!", lineZh:'我是风，顺着光滑的车头滑过！', lineKey:'hsr_03_1'}) +
    partSVG({px:635,py:235,name:'Window',nameZh:'车窗',fact:'driver looks ahead',factZh:'司机向前看',
      line:"I'm the window — the driver watches ahead through me!", lineZh:'我是车窗，司机透过我看前方！', lineKey:'hsr_03_2'})
  ),
  hsr_04: () => svgWrap(
    partSVG({px:310,py:455,name:'Passengers',nameZh:'乘客',fact:'sit comfortably inside',factZh:'舒适地坐在里面',
      line:"We're passengers — sitting comfy inside!", lineZh:'我们是乘客，舒舒服服坐在里面！', lineKey:'hsr_04_0'}) +
    partSVG({px:630,py:550,name:'Carriage',nameZh:'车厢',fact:'a long connected room',factZh:'一节长长的连接房间',
      line:"I'm a carriage — a long room on wheels!", lineZh:'我是车厢，带轮子的长房间！', lineKey:'hsr_04_1'}) +
    partSVG({px:750,py:390,name:'Seats',nameZh:'座椅',fact:'soft chairs for riders',factZh:'给乘客坐的软椅',
      line:"We're seats — soft chairs for riders!", lineZh:'我们是座椅，给乘客坐的软椅子！', lineKey:'hsr_04_2'})
  ),
  hsr_05: () => svgWrap(
    partSVG({px:650,py:665,name:'Track',nameZh:'铁轨',fact:'steel rails for wheels',factZh:'给车轮跑的钢轨',
      line:"I'm the track — steel rails for the wheels!", lineZh:'我是铁轨，给车轮跑的钢轨！', lineKey:'hsr_05_0'}) +
    partSVG({px:440,py:355,name:'Train',nameZh:'高铁',fact:'runs on two rails',factZh:'在两条轨道上跑',
      line:"I'm the train — I run on two rails!", lineZh:'我是高铁，在两条轨道上跑！', lineKey:'hsr_05_1'}) +
    partSVG({px:990,py:415,name:'Fields',nameZh:'田野',fact:'green land beside the track',factZh:'轨道旁的绿色大地',
  ...
  hsr_06: () => svgWrap(
    ...
    partSVG({px:350,py:605,name:'Train body',nameZh:'车身',fact:'uses the power to move',factZh:'用电力前进',
      line:"I'm the train body — I use the power to move!", lineZh:'我是车身，我用电力前进！', lineKey:'hsr_06_2'})
  ),
  hsr_07: () => svgWrap(
    partSVG({px:820,py:565,name:'Wheels',nameZh:'车轮',fact:'turned by electric motors',factZh:'由电动机带动',
      line:"We're wheels — spun by electric motors!", lineZh:'我们是车轮，由电动机带动！', lineKey:'hsr_07_0'}) +
    partSVG({px:510,py:430,name:'Lightning',nameZh:'电',fact:'electric energy in motion',factZh:'运动中的电能',
      line:"I'm electricity — energy on the move!", lineZh:'我是电，运动中的能量！', lineKey:'hsr_07_1'}) +
    partSVG({px:1130,py:380,name:'Tunnel',nameZh:'隧道',fact:'a dark mountain passage',factZh:'穿山的黑暗通道',
      line:"I'm the tunnel — a dark mountain passage!", lineZh:'我是隧道，穿山的黑暗通道！', lineKey:'hsr_07_2'})
  ),
  hsr_08: () => svgWrap(
    partSVG({px:760,py:610,name:'Bridge',nameZh:'桥梁',fact:'crosses over the river',factZh:'横跨河流',
      line:"I'm the bridge — I cross over the river!", lineZh:'我是桥梁，横跨河流！', lineKey:'hsr_08_0'}) +
    partSVG({px:955,py:670,name:'River',nameZh:'河流',fact:'flows under the bridge',factZh:'在桥下流淌',
      line:"I'm the river — I flow under the bridge!", lineZh:'我是河流，在桥下流淌！', lineKey:'hsr_08_1'}) +
    partSVG({px:1070,py:305,name:'Tunnel',nameZh:'隧道',fact:'goes through the mountain',factZh:'穿过山体',
      line:"I'm the tunnel — I go through the mountain!", lineZh:'我是隧道，穿过山体！', lineKey:'hsr_08_2'})
  ),
  hsr_09: () => svgWrap(
    partSVG({px:310,py:580,name:'Train',nameZh:'高铁',fact:'coming out of the tunnel',factZh:'从隧道里出来',
  ...
  hsr_10: () => svgWrap(
    partSVG({px:275,py:445,name:'Driver',nameZh:'司机',fact:'steers the train safely',factZh:'安全驾驶火车',
      line:"I'm the driver — I steer the train safely!", lineZh:'我是司机，安全驾驶火车！', lineKey:'hsr_10_0'}) +
    partSVG({px:655,py:450,name:'Control panel',nameZh:'控制台',fact:'buttons and screens',factZh:'按钮和屏幕',
      line:"I'm the control panel — buttons and screens!", lineZh:'我是控制台，按钮和屏幕！', lineKey:'hsr_10_1'}) +
    partSVG({px:885,py:215,name:'Front window',nameZh:'前窗',fact:'sees the track ahead',factZh:'看到前方轨道',
      line:"I'm the front window — I see the track ahead!", lineZh:'我是前窗，看到前方轨道！', lineKey:'hsr_10_2'})
  ),
  hsr_11: () => svgWrap(
    partSVG({px:690,py:490,name:'Train',nameZh:'高铁',fact:'races really fast',factZh:'跑得飞快',
      line:"I'm the train — I race really fast!", lineZh:'我是高铁，跑得飞快！', lineKey:'hsr_11_0'}) +
    partSVG({px:200,py:155,name:'Speedometer',nameZh:'速度表',fact:'shows how fast it goes',factZh:'显示速度有多快',
      line:"I'm the speedometer — I show how fast we go!", lineZh:'我是速度表，显示速度有多快！', lineKey:'hsr_11_1'}) +
    partSVG({px:1000,py:130,name:'Cloud',nameZh:'云朵',fact:'the train almost catches it',factZh:'火车差点追上它',
      line:"I'm a cloud — the train almost catches me!", lineZh:'我是云朵，火车差点追上我！', lineKey:'hsr_11_2'})
  ),
  hsr_12: () => svgWrap(
    partSVG({px:560,py:475,name:'Train',nameZh:'高铁',fact:'all parts work together',factZh:'所有部件一起工作',
