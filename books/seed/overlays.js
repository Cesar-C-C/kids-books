...
window.OVL = {
  seed_cover: () => svgWrap(
    ...
    partSVG({px:610, py:615,name:'Seed',nameZh:'种子',fact:'a baby plant waiting to grow',factZh:'一个等待长大的小宝宝植物',
  ...
  seed_02: () => svgWrap(
    partSVG({px:585, py:505,name:'Seed',nameZh:'种子',fact:'sleeping in the cozy soil',factZh:'在舒服的泥土里睡觉',
      line:"I'm the Seed — cozy and sleepy in the soil!", lineZh:'我是种子，在土里舒舒服服地睡觉！', lineKey:'seed_02_0'}) +
    partSVG({px:930, py:470,name:'Worm',nameZh:'蚯蚓',fact:'a friend who helps the soil',factZh:'帮助泥土松软的好朋友',
      line:"I'm a Worm — I make the soil soft and friendly!", lineZh:'我是蚯蚓，让泥土变得松软又舒服！', lineKey:'seed_02_1'})
  ),
  seed_03: () => svgWrap(
    partSVG({px:480, py:215,name:'Raindrop',nameZh:'雨滴',fact:'wakes the seed up',factZh:'叫醒种子',
      line:"I'm a Raindrop — I tap the seed to wake up!", lineZh:'我是雨滴，轻轻敲醒种子！', lineKey:'seed_03_0'}) +
    partSVG({px:585, py:595,name:'Seed',nameZh:'种子',fact:'drinks water and starts to grow',factZh:'喝水后开始生长',
      line:"I'm the Seed — I drink water and start to grow!", lineZh:'我是种子，喝水后开始长大！', lineKey:'seed_03_1'}) +
    partSVG({px:640, py:290,name:'Sprout',nameZh:'小芽',fact:'first green leaves above the soil',factZh:'钻出泥土的第一片绿叶',
      line:"I'm a Sprout — I push up through the soil!", lineZh:'我是小芽，顶开泥土钻出来！', lineKey:'seed_03_2'})
  ),
  seed_04: () => svgWrap(
    partSVG({px:590, py:460,name:'Roots',nameZh:'根',fact:'grow down to hold the plant',factZh:'往下长，紧紧抓住植物',
      line:"I'm Roots — I grow down to hold the plant tight!", lineZh:'我是根，往下长紧紧抓住植物！', lineKey:'seed_04_0'}) +
    partSVG({px:255, py:670,name:'Stone',nameZh:'石头',fact:'roots grow around it',factZh:'根会绕开它生长',
      line:"I'm a Stone — roots grow around me!", lineZh:'我是石头，根会绕着我长！', lineKey:'seed_04_1'}) +
    partSVG({px:990, py:600,name:'Worm',nameZh:'蚯蚓',fact:'makes tunnels in the soil',factZh:'在土里钻出通道',
      line:"I'm a Worm — I dig tunnels in the soil!", lineZh:'我是蚯蚓，在土里钻出通道！', lineKey:'seed_04_2'})
  ),
  seed_05: () => svgWrap(
    partSVG({px:270, py:145,name:'Sun',nameZh:'太阳',fact:'gives energy to the plant',factZh:'给植物能量',
      line:"I'm the Sun — I give the plant energy!", lineZh:'我是太阳，给植物能量！', lineKey:'seed_05_0'}) +
    partSVG({px:630, py:520,name:'Stem',nameZh:'茎',fact:'carries water up to the leaves',factZh:'把水送到叶子上',
      line:"I'm the Stem — I carry water up to the leaves!", lineZh:'我是茎，把水送到叶子上！', lineKey:'seed_05_1'}) +
    partSVG({px:480, py:270,name:'Leaf',nameZh:'叶子',fact:'catches sunlight and makes food',factZh:'吸收阳光，制造养分',
  ...
  seed_06: () => svgWrap(
    ...
    partSVG({px:930, py:290,name:'Butterfly',nameZh:'蝴蝶',fact:'visits flowers for sweet nectar',factZh:'来花丛喝甜甜的花蜜',
  ...
  seed_07: () => svgWrap(
    ...
    partSVG({px:690, py:340,name:'Bee',nameZh:'蜜蜂',fact:'carries pollen from flower to flower',factZh:'把花粉从一朵花带到另一朵花',
  ...
  seed_08: () => svgWrap(
    ...
    partSVG({px:190, py:100,name:'Leaves',nameZh:'树叶',fact:'make food for the tree',factZh:'为大树制造养分',
  ...
  seed_09: () => svgWrap(
    ...
    partSVG({px:770, py:230,name:'Bird',nameZh:'小鸟',fact:'helps seeds travel far',factZh:'帮助种子去远方',
      line:"I'm a Bird — I help seeds travel far!", lineZh:'我是小鸟，帮种子去远方！', lineKey:'seed_09_1'}) +
    partSVG({px:960, py:200,name:'Seeds',nameZh:'种子',fact:'riding the wind to a new home',factZh:'随风飘向新家',
      line:"We're Seeds — riding the wind to a new home!", lineZh:'我们是种子，随风飘向新家！', lineKey:'seed_09_2'})
  ),
  seed_10: () => svgWrap(
    partSVG({px:630, py:330,name:'Seedling',nameZh:'小苗',fact:'a young plant starting its journey',factZh:'开始新旅程的小植物',
