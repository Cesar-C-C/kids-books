(() => {
 ...
 function renderLesson(){
  ...
  $('part-zh-name').after($('operation-panel'));$('operation-panel').after($('explore-section'));updateButtons();
 }
 ...
 function init(){
  ...
  // HELLO, / YOUR AIRPLANE captions sit behind the model instead of on top of it.
  scene=new T.Scene();camera=new T.PerspectiveCamera(42,1,.02,180);
